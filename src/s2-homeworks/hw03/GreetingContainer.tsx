...
export const pureAddUser = (name: string, setError: Function, setName: Function, addUserCallback: Function) => {
    name === '' ? setError('Ошибка! Введите имя!') : addUserCallback(name);  setName('')
}

export const pureOnBlur = (name: string, setError: Function) => { // е
    name === '' ? setError('Ошибка! Введите имя!') : setError('')// сли имя пустое - показать ошибку
}
